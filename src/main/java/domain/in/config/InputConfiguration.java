...
public class InputConfiguration {
  ...
  /** ArrayList with the list of domain.rules obtained from the config file. */
  ...
  /**
   * Getter of one specific field inside the list of domain.rules.
   *
   * @param rule Integer that indicates which field we get, goes from 0 to length of domain.rules.
  ...
  /**
   * Function that returns the stream.distribution domain.rules of the nodes that distribute the node with the id
   * passed as parameter.
   *
